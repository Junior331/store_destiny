...
const CustomToastContent = ({ message, icon }: CustomToastProps) => (
      ...
      () => (
        <div
          style={{
            ...
            background: 'linear-gradient(90deg, rgba(50, 171, 113, 0.15) 60.24%, rgba(50, 171, 113, 0.00) 96.34%)',
            color: '#FFF',
            fontFamily: 'Poppins',
            fontSize: '16px',
            fontWeight: 500,
      ...
      () => (
        <div
          style={{
            ...
            border: '1px solid #3F3F3F',
            backdropFilter: 'blur(30px)',
            background: 'linear-gradient(90deg, rgba(241, 68, 68, 0.15) 60.24%, rgba(241, 68, 68, 0.00) 96.34%)',
            color: '#FFF',
            fontFamily: 'Poppins',
            fontSize: '16px',
            fontWeight: 500,
      ...
      () => (
        <div
          style={{
            ...
            border: '1px solid #3F3F3F',
            backdropFilter: 'blur(30px)',
            background: 'linear-gradient(90deg, rgba(241, 182, 68, 0.15) 60.24%, rgba(241, 182, 68, 0.00) 96.34%)',
            color: '#FFF',
            fontFamily: 'Poppins',
            fontSize: '16px',
            fontWeight: 500,
      ...
      () => (
        <div
          style={{
            ...
            border: '1px solid #3F3F3F',
            backdropFilter: 'blur(30px)',
            background: 'linear-gradient(90deg, rgba(217, 217, 217, 0.15) 60.24%, rgba(217, 217, 217, 0.00) 96.34%)',
            color: '#FFF',
            fontFamily: 'Poppins',
            fontSize: '16px',
            fontWeight: 500,
