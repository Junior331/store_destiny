...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#0F0F0F] text-footer-foreground">
          ...
          <div className="flex items-center gap-8">
            <div className="flex gap-4">
              ...
              >
                ...
                >
                  <path
                    d="M47.6916 7.28644C47.6916 3.41936 44.5881 0.308507 40.7532 0.308507C35.5588 0.0859349 30.2613 0 24.8475 0H23.1597C17.7591 0 12.4521 0.085935 7.25774 0.309366C3.43225 0.309366 0.328737 3.43741 0.328737 7.30449C0.094332 10.3629 -0.00505554 13.4222 0.000570173 16.4815C-0.00880601 19.5408 0.0974574 22.603 0.31936 25.668C0.31936 29.5351 3.42288 32.6717 7.24836 32.6717C12.7053 32.9037 18.3029 33.0068 23.9942 32.9982C29.6949 33.0154 35.2769 32.9066 40.7401 32.6717C44.5749 32.6717 47.6785 29.5351 47.6785 25.668C47.9035 22.6001 48.0066 19.5408 47.9972 16.4729C48.0185 13.4136 47.9166 10.3515 47.6916 7.28644ZM19.4093 24.9117V8.02549L33.0047 16.4643L19.4093 24.9117Z"
                    fill="#6D747B"
                  />
                </svg>
              </a>
          ...
          <div>
            <div className="mb-6">
              <p className="text-sm text-footer-foreground leading-relaxed max-w-4xl">
                © {currentYear}, Destiny Community. Todos os direitos
                reservados. Destiny, Logotipo de Destiny Community, San
                Battlegrounds, o logo tipo do San Battlegrounds são marcas
                comerciais ou registradas do Destiny Community no Brasil. Grand
                Theft Auto, Grand Theft Auto: V e Grand Theft Auto: San Andreas
                são marcas registradas da Take-Two Interactive Software. Todas
                as marcas comerciais usadas pertencem aos seus respectivos
                proprietários. Destiny Community são é afiliada ou endossado
                pela Take-Two Interactive Software.
              </p>
            </div>
