  ...
  return (
    <div className="min-h-screen w-full relative">
      ...
      <div className="relative before:content-[''] before:fixed before:inset-0 before:bg-[rgba(12,12,12,0.10)]">
        ...
        >
          <div className={cn("w-full max-w-[435px] py-[48px] px-[45px] rounded-[8px] bg-[#262626cc] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] backdrop-blur-[30px] scale-90 relative z-10", className)}>
            {logo && (
