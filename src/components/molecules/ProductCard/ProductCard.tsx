...
export function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <div
      className="relative w-[238px] h-[333px] rounded-[20px] overflow-hidden group/card transition-all duration-300"
      style={{
    ...
    >
      {/* Background Glow */}
      <div
        className="absolute inset-0 rounded-[20px] pointer-events-none transition-opacity duration-300 group-hover/card:opacity-0"
        style={{ background: rarityColors.glowBg }}
      />

      {/* Hover Glow */}
      <div
        className="absolute inset-0 rounded-[20px] pointer-events-none transition-opacity duration-300 opacity-0 group-hover/card:opacity-100"
        style={{ background: rarityColors.hoverGlow }}
      />

      {/* Destiny Logo SVG - Bottom Right */}
      ...
      <div className="relative z-10 p-4 flex flex-col h-full">
        ...
        <div className="space-y-3 mt-4">
          ...
          <div className="text-center">
            <Typography variant="small" className="text-accent font-semibold">
              {formatCash(product.cashAmount)} Cash
            </Typography>
          </div>
          ...
          {!inCart ? (
            ...
            <div className="flex items-center gap-2">
              ...
              <Typography variant="h4" className="min-w-[2rem] text-center text-white">
                {quantity}
              </Typography>
              <Button
