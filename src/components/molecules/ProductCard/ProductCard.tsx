...
> = {
  common: {
    ...
    gradientEnd: "#A3EA5F",
    hoverGlow:
      "radial-gradient(50% 40% at 50% 50%, rgba(163, 234, 95, 0.3) 0%, rgba(24, 61, 72, 0.00) 100%)",
  },
  rare: {
    border: "#332F20",
    ...
    gradientEnd: "#F5CF5E",
    hoverGlow:
      "radial-gradient(50% 40% at 50% 50%, hsla(16, 45%, 44%, 0.3) 0%, rgba(24, 61, 72, 0.00) 100%)",
  },
  epic: {
    border: "#27232F",
...
export function ProductCard({
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 left-0 -top-7 max-h-[293px]
         rounded-2xl pointer-events-none transition-opacity duration-300 opacity-0 group-hover/card:opacity-100"
      ...
      {checkoutMode ? (
        ...
        <div className="absolute top-4 right-4 pointer-events-none">
          ...
          >
            <path
              d="M15 89L-4.36736e-08 89L-8.73471e-08 88L15 88L15 89ZM15 87L-1.31021e-07 87L-2.62041e-07 84L15 84L15 87Z"
              fill={`url(#paint0_qr_${product.id})`}
            />
            <path
              d="M15 83L-3.05715e-07 83L-3.49389e-07 82L15 82L15 83ZM15 81L-3.93062e-07 81L-4.80409e-07 79L15 79L15 81ZM15 78L-5.24083e-07 78L-6.1143e-07 76L15 76L15 78Z"
              fill={`url(#paint1_qr_${product.id})`}
            />
            <path
              d="M15 75L-6.55104e-07 75L-6.98777e-07 74L15 74L15 75ZM15 71L-8.29798e-07 71L-8.73471e-07 70L15 70L15 71ZM15 69L-9.17145e-07 69L-9.60819e-07 68L15 68L15 69Z"
              fill={`url(#paint2_qr_${product.id})`}
            />
            <path
              d="M15 66L-1.04817e-06 66L15 66ZM15 63L-1.17919e-06 63L-1.31021e-06 60L15 60L15 63ZM15 59L-1.35388e-06 59L15 59Z"
              fill={`url(#paint3_qr_${product.id})`}
            />
            <path
              d="M15 58L-1.39755e-06 58L-1.52858e-06 55L15 55L15 58ZM15 54L-1.57225e-06 54L-1.6596e-06 52L15 52L15 54ZM15 51L-1.70327e-06 51L-1.74694e-06 50L15 50L15 51Z"
              fill={`url(#paint4_qr_${product.id})`}
            />
            <path
              d="M15 50L-1.74694e-06 50L-1.87796e-06 47L15 47L15 50ZM15 46L-1.92164e-06 46L-2.05266e-06 43L15 43L15 46ZM15 43L-2.05266e-06 43L-2.09633e-06 42L15 42L15 43Z"
              fill={`url(#paint5_qr_${product.id})`}
            />
            <path
              d="M15 41L-2.14001e-06 41L-2.18368e-06 40L15 40L15 41ZM15 39L-2.22735e-06 39L-2.35837e-06 36L15 36L15 39ZM15 34L-2.44572e-06 34L15 34Z"
              fill={`url(#paint6_qr_${product.id})`}
            />
            <path
              d="M15 33L-2.48939e-06 33L-2.57674e-06 31L15 31L15 33ZM15 28L-2.70776e-06 28L-2.75144e-06 27L15 27L15 28ZM15 27L-2.75144e-06 27L-2.79511e-06 26L15 26L15 27Z"
              fill={`url(#paint7_qr_${product.id})`}
            />
            <path
              d="M15 24L-2.88246e-06 24L15 24ZM15 21L-3.01348e-06 21L-3.10082e-06 19L15 19L15 21ZM15 18L-3.1445e-06 18L15 18Z"
              fill={`url(#paint8_qr_${product.id})`}
            />
            <path
              d="M15 16L-3.23184e-06 16L-3.27552e-06 15L15 15L15 16ZM15 14L-3.31919e-06 14L-3.45021e-06 11L15 11L15 14ZM15 10L-3.49389e-06 10L-3.53756e-06 9L15 9L15 10Z"
              fill={`url(#paint9_qr_${product.id})`}
            />
            <path
              d="M15 8L-3.58123e-06 8L-3.66858e-06 6L15 6L15 8ZM15 5L-3.71225e-06 5L-3.75593e-06 4L15 4L15 5ZM15 3L-3.7996e-06 3L-3.93062e-06 0L15 -6.56239e-07L15 3Z"
              fill={`url(#paint10_qr_${product.id})`}
            />
            <defs>
              {[...Array(11)].map((_, i) => (
                <linearGradient
                  key={i}
                  id={`paint${i}_qr_${product.id}`}
                  x1="-1.96531e-06"
                  y1="45"
                  x2="15"
                  y2="45"
            ...
            <div className="flex items-center gap-2">
              ...
              {product.discountedPrice && product.discount && (
                <div className="flex flex-col">
                  ...
                  <span
                    className="px-1 pr-2 w-fit rounded-[14px] text-[10px] font-medium italic leading-[14px]"
                    style={{
