  ...
  return (
    ...
    >
      {gateways.map((gateway) => {
        ...
        return isSelected ? (
          <div
            className="shiny-button relative flex flex-col items-center justify-center transition-all duration-300 bg-[#2A6C80] overflow-hidden p-2 rounded-xl gap-2.5"
            key={gateway}
          >
            <PaymentGatewayButton
              gateway={gateway}
